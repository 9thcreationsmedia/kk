                    ...
                    <button class="btn btn-lightred btn-ef btn-ef-4 btn-ef-4c"><i class="fa fa-arrow-left"></i>Update</button>
                        <button class="btn btn-success btn-ef btn-ef-3 btn-ef-3c"  data-dismiss="modal"><i class="fa fa-arrow-right"></i>Cancel</button>
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong> Class Settings</strong></h1>
                                       ...
                                       <table class="table table-custom" id="editable-usage">
                                            ...
                                            @endforeach
                                               ...
                                               <td><?php echo $row->status; ?></td>
                                                ...
                                                <td><a href="{{ URL::to('sectionupdateform') }}/{{$row->id}}">EDIT/<a id="delete" data-confirm="Are you sure to delete this item?" href="{{ URL::to('sectiondelete')}}/{{$row->id}}" onclick = "myFunction()">DELETE</a></a></td>
