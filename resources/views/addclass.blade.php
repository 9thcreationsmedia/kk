            ...
            <section id="content">
                ...
                <div class="page page-tables-datatables">
                    ...
                    <div class="row">
                       ...
                       <div class="tile-body">
                           <div class="row">
                                 <form name="form" action="classaddform" method="post" role="form" id="form">

                                       
                                          <div class="form-group">
                                            <label for="selectclass" class="col-sm-2 control-label">Class Name</label>
                                            <div class="col-sm-6">
                                                 <input type="text" name="class_name" id="selectclass" ng-model="ct" class="form-control">
                                            </div>
                                        </div>
                                        </div>
                                       ...
                                       <!-- <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" name="class_teacher" id="ct" ng-model="ct" class="form-control">
                                            </div>
