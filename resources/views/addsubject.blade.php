            ...
            <section id="content">
                ...
                <div class="page page-tables-datatables">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            @if ($errors->any())
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Add Subject</strong></h1>
                       ...
                       <div class="tile-body">
                           <div class="row">
                                 <form name="form" action="subjectaddform" method="post" role="form" id="form">

                                       
                                          <div class="form-group">
                                            <label for="selectclass" class="col-sm-2 control-label">Subject Name</label>
                                            <div class="col-sm-6">
                                                 <input type="text" name="subject_name" id="selectclass" ng-model="ct" class="form-control">
                                            </div>
                                        </div>
                                        </div>
                                      <div class="row">   
                                      ...
                                      <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <select class="form-control" name="section_name" id="sectionname">
                                      ...
                                      <div class="form-group">
                                            <label for="input01" class="col-sm-2 control-label"> Teacher </label>
                                            <div class="col-sm-6">
                                                <select class="form-control" name="subject_teacher" id="cname">
<!-- 
    @foreach ($cname as $classname)          
    {
        <option value="{{$classname->id}}">{{$classname->class_name}}</option>
    ...
    <option value="chennakesavarao">Chennakesavarao</option>
    <option value="Madhavareddy">Madhavareddy</option>
                                   ...
                                   <!--     <div class="row">
                                        <div class="form-group">
                                            <label for="ced" class="col-sm-2 control-label">Subject Established Date</label>
                                            <div class='input-group date col-sm-6' id='datetimepicker1'>
                                                <input type='text' class="form-control" name="subject_date" id="ced"  required />
