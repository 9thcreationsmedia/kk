                                        ...
                                        <table class="table table-custom" id="editable-usage">
                                            ...
                                            <tr class="odd gradeX">
                                               ...
                                               <td><?php echo $row->class_teacher; ?></td>
                                                ...
                                                <td><a href="{{ URL::to('classupdateform') }}/{{$row->id}}">EDIT</a>/
                                                <a href="{{ URL::to('classdelete') }}/{{$row->id}}" onclick="return confirm('Are you sure you want to delete this case?');">DELETE</a></td>
