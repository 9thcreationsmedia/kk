            ...
            <section id="content">
                ...
                <div class="page page-tables-datatables">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>update Class</strong></h1>
                       ...
                       <div class="tile-body">
                           <div class="row">
                                 <form name="form" action="{{action('ClassController@classupdate')}}" method="post" role="form" id="form">
                                       ...
                                       <!-- <div class="row">
                                        <div class="form-group">
                                            <label for="ced" class="col-sm-2 control-label">Class Established Date</label>
                                           ...
                                           <div class="row">
                                        <div class="form-group">
                                            <label for="ct" class="col-sm-2 control-label">Class Teacher</label>
                                            <div class="col-sm-6">
                                                <input type="text" name="class_teacher" id="ct" ng-model="ct" class="form-control" value="<?php echo $data->class_teacher?>">
                                            </div>
