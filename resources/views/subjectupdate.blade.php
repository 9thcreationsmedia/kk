            ...
            <section id="content">
                ...
                <div class="page page-tables-datatables">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>update subject</strong></h1>
                       ...
                       <div class="tile-body">
                           <div class="row">
                                 <form name="form" action="{{action('SubjectController@subjectupdate')}}" role="form" id="form" method="post">
                                   <div class="row">
                                          <div class="form-group">
                                            <label for="selectclass" class="col-sm-2 control-label">Subject Name</label>
                                            <div class="col-sm-6">
                                                 <input type="text" name="subject_name" id="subjectname" ng-model="ct" class="form-control" value="<?php echo $sname->subject_name?>">
                                            </div>
                                        </div>
                                        </div>
                                   <div class="row">
                                          <div class="form-group">
                                            ...
                                            <select  class="form-control" name="class_id" id="classname">
                                                   ...
                                                   <option value="<?php echo $sname->class_id;?>" selected><?php echo $classname;?></option>  
                                        ...
                                        <div class="row">
                                          <div class="form-group">
                                            ...
                                            <select  class="form-control" name="section_id" id="sectionname">
                                                   ...
                                                   <option value="<?php echo $sname->section_id;?>" selected><?php echo $sectionname;?></option>  
                                                  @foreach($secname as $sectioncode)
                                                      
                                                  <option value="{{ $sectioncode->id }}">{{ $sectioncode->section_name }}</option>
                                        ...
                                        <div class="row">
                                          <div class="form-group">
                                            <label for="selectclass" class="col-sm-2 control-label">Subject Teacher</label>
                                            <div class="col-sm-6">
<select  class="form-control" name="subject_teacher" id="subjectname">

  <option value="<?php echo $sname->subject_teacher?>" selected><?php echo $sname->subject_teacher?></option>  
